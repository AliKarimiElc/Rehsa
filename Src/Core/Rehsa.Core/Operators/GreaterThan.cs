...
/// <summary>
/// Check that suspected data of collected data greater than input data or not
/// </summary>
public class GreaterThan<T> : IConditionalOperator where T : IEquatable<T>
{
    /// <summary>
    /// Condition data
    /// </summary>
    ...
    /// <summary>
    /// Create greater than conditional operator
    /// </summary>
